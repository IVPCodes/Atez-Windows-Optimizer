...
$Global:SoftwareCatalog = @(
    ...
    @{ Name="Chromium";              Id="Hibbiki.Chromium";                     Category="Browsers" }
    @{ Name="Edge";                  Id="Microsoft.Edge";                       Category="Browsers" }
    @{ Name="Firefox";               Id="Mozilla.Firefox";                      Category="Browsers" }
    @{ Name="Firefox ESR";           Id="Mozilla.Firefox.ESR";                  Category="Browsers" }
    @{ Name="Floorp";                Id="Floorp.Floorp";                        Category="Browsers" }
    @{ Name="Helium";                Id="imputnet.Helium";                      Category="Browsers" }
    @{ Name="LibreWolf";             Id="LibreWolf.LibreWolf";                  Category="Browsers" }
    @{ Name="Mullvad Browser";       Id="MullvadVPN.MullvadBrowser";            Category="Browsers" }
    @{ Name="Tor Browser";           Id="TorProject.TorBrowser";                Category="Browsers" }
    @{ Name="Ungoogled Chromium";    Id="eloston.ungoogled-chromium";           Category="Browsers" }
    @{ Name="Vivaldi";               Id="VivaldiTechnologies.Vivaldi";          Category="Browsers" }
    @{ Name="Waterfox";              Id="Waterfox.Waterfox";                    Category="Browsers" }
    @{ Name="Zen Browser";           Id="Zen-Team.Zen-Browser";                 Category="Browsers" }


    @{ Name="Betterbird";            Id="Betterbird.Betterbird";                Category="Communications" }
    @{ Name="Chatterino";            Id="ChatterinoTeam.Chatterino";            Category="Communications" }
    @{ Name="Discord";               Id="Discord.Discord";                      Category="Communications" }
    @{ Name="Dorion";                Id="SpikeHD.Dorion";                       Category="Communications" }
    @{ Name="Element";               Id="Element.Element";                      Category="Communications" }
    @{ Name="Proton Mail";           Id="Proton.ProtonMail";                    Category="Communications" }
    @{ Name="QTox";                  Id="Tox.qTox";                             Category="Communications" }
    @{ Name="Signal";                Id="OpenWhisperSystems.Signal";            Category="Communications" }
    @{ Name="Slack";                 Id="SlackTechnologies.Slack";              Category="Communications" }
    @{ Name="Teams";                 Id="Microsoft.Teams";                      Category="Communications" }
    @{ Name="TeamSpeak 3";           Id="TeamSpeakSystems.TeamSpeakClient";     Category="Communications" }
    @{ Name="Telegram";              Id="Telegram.TelegramDesktop";             Category="Communications" }
    @{ Name="Thunderbird";           Id="Mozilla.Thunderbird";                  Category="Communications" }
    @{ Name="Vesktop";               Id="Vencord.Vesktop";                      Category="Communications" }
    @{ Name="Viber";                 Id="Viber.Viber";                          Category="Communications" }
    @{ Name="Zoom";                  Id="Zoom.Zoom";                            Category="Communications" }


    @{ Name="Amazon Corretto 8 (LTS)";  Id="Amazon.Corretto.8.JDK";             Category="Development" }
    @{ Name="Amazon Corretto 21 (LTS)"; Id="Amazon.Corretto.21.JDK";            Category="Development" }
    @{ Name="Amazon Corretto 25 (LTS)"; Id="Amazon.Corretto.25.JDK";            Category="Development" }
    @{ Name="CMake";                 Id="Kitware.CMake";                        Category="Development" }
    ...
    @{ Name="Lazygit";               Id="JesseDuffield.lazygit";                Category="Development" }
    @{ Name="Lua";                   Id="Lua.Lua";                              Category="Development" }
    @{ Name="Neovim";                Id="Neovim.Neovim";                        Category="Development" }
    @{ Name="NodeJS";                Id="OpenJS.NodeJS";                        Category="Development" }
    @{ Name="NodeJS LTS";            Id="OpenJS.NodeJS.LTS";                    Category="Development" }
    @{ Name="Oh My Posh (Prompt)";   Id="JanDeDobbeleer.OhMyPosh";              Category="Development" }
    @{ Name="pnpm";                  Id="pnpm.pnpm";                            Category="Development" }
    @{ Name="Python3";               Id="Python.Python.3.12";                   Category="Development" }
    @{ Name="Rust";                  Id="Rustlang.Rust.MSVC";                   Category="Development" }
    @{ Name="Ruby";                  Id="RubyInstallerTeam.Ruby";               Category="Development" }
    @{ Name="Sublime Text";          Id="SublimeHQ.SublimeText.4";              Category="Development" }
    @{ Name="System Informer";       Id="WinsiderSS.SystemInformer";            Category="Development" }
    @{ Name="Unity Game Engine";     Id="Unity.UnityHub";                       Category="Development" }
    @{ Name="uv";                    Id="astral-sh.uv";                         Category="Development" }
    @{ Name="Visual Studio 2022";    Id="Microsoft.VisualStudio.2022.Community"; Category="Development" }
    @{ Name="Visual Studio 2026";    Id="Microsoft.VisualStudio.2026.Community"; Category="Development" }
    @{ Name="VS Code";               Id="Microsoft.VisualStudioCode";           Category="Development" }
    @{ Name="VS Codium";             Id="VSCodium.VSCodium";                    Category="Development" }
    @{ Name="Yarn";                  Id="Yarn.Yarn";                            Category="Development" }
    @{ Name="Zed";                   Id="Zed-Industries.Zed";                   Category="Development" }


    @{ Name="Cemu";                  Id="Cemu.Cemu";                            Category="Games" }
    @{ Name="EA App";                Id="ElectronicArts.EADesktop";             Category="Games" }
    @{ Name="Epic Games Launcher";   Id="EpicGames.EpicGamesLauncher";          Category="Games" }
    @{ Name="GeForce NOW";           Id="Nvidia.GeForceNow";                    Category="Games" }
    @{ Name="GOG Galaxy";            Id="GOG.Galaxy";                           Category="Games" }
    @{ Name="Heroic Games Launcher"; Id="HeroicGamesLauncher.HeroicGamesLauncher"; Category="Games" }
    @{ Name="Itch.io";               Id="ItchIo.Itch";                          Category="Games" }
    @{ Name="Modrinth App";          Id="Modrinth.ModrinthApp";                 Category="Games" }
    @{ Name="Overwolf";              Id="Overwolf.Overwolf";                    Category="Games" }
    @{ Name="Playnite";              Id="Playnite.Playnite";                    Category="Games" }
    @{ Name="Prism Launcher";        Id="PrismLauncher.PrismLauncher";          Category="Games" }
    @{ Name="Steam";                 Id="Valve.Steam";                          Category="Games" }
    @{ Name="Ubisoft Connect";       Id="Ubisoft.Connect";                      Category="Games" }
    @{ Name="Virtual Desktop Streamer"; Id="VirtualDesktop.Streamer";           Category="Games" }


    @{ Name="Autoruns";              Id="Microsoft.Sysinternals.Autoruns";      Category="Microsoft Tools" }
    @{ Name="DISMTools";             Id="AveYo.DISMTools";                      Category="Microsoft Tools" }
    @{ Name=".NET Desktop Runtime 6"; Id="Microsoft.DotNet.DesktopRuntime.6";   Category="Microsoft Tools" }
    @{ Name=".NET Desktop Runtime 8"; Id="Microsoft.DotNet.DesktopRuntime.8";   Category="Microsoft Tools" }
    @{ Name=".NET Desktop Runtime 9"; Id="Microsoft.DotNet.DesktopRuntime.9";   Category="Microsoft Tools" }
    @{ Name=".NET Desktop Runtime 10"; Id="Microsoft.DotNet.DesktopRuntime.10"; Category="Microsoft Tools" }
    @{ Name="NTLite";                Id="NTLite.NTLite";                        Category="Microsoft Tools" }
    @{ Name="NuGet";                 Id="Microsoft.NuGet";                      Category="Microsoft Tools" }
    @{ Name="OneDrive";              Id="Microsoft.OneDrive";                   Category="Microsoft Tools" }
    @{ Name="PowerShell";            Id="Microsoft.PowerShell";                 Category="Microsoft Tools" }
    @{ Name="PowerToys";             Id="Microsoft.PowerToys";                  Category="Microsoft Tools" }
    @{ Name="Process Explorer";      Id="Microsoft.Sysinternals.ProcessExplorer"; Category="Microsoft Tools" }
    @{ Name="RDCMan";                Id="Microsoft.Sysinternals.RDCMan";        Category="Microsoft Tools" }
    @{ Name="Sysinternals Process Monitor"; Id="Microsoft.Sysinternals.ProcMon"; Category="Microsoft Tools" }
    @{ Name="Sysinternals TCPView";  Id="Microsoft.Sysinternals.TCPView";       Category="Microsoft Tools" }
    @{ Name="Visual C++ 2015-2022 32-bit"; Id="Microsoft.VCRedist.2015+.x86";   Category="Microsoft Tools" }
    @{ Name="Visual C++ 2015-2022 64-bit"; Id="Microsoft.VCRedist.2015+.x64";   Category="Microsoft Tools" }
    @{ Name="Windows Terminal";      Id="Microsoft.WindowsTerminal";            Category="Microsoft Tools" }


    @{ Name="Adobe Acrobat Reader";  Id="Adobe.Acrobat.Reader.64-bit";          Category="Multimedia Tools" }
    @{ Name="AIMP (Music Player)";   Id="AIMP.AIMP";                            Category="Multimedia Tools" }
    @{ Name="Audacity";              Id="Audacity.Audacity";                    Category="Multimedia Tools" }
    @{ Name="Blender (3D Graphics)"; Id="BlenderFoundation.Blender";            Category="Multimedia Tools" }
    @{ Name="Calibre";               Id="calibre.calibre";                      Category="Multimedia Tools" }
    @{ Name="EarTrumpet (Audio)";    Id="File-New-Project.EarTrumpet";          Category="Multimedia Tools" }
    @{ Name="GIMP (Image Editor)";   Id="GIMP.GIMP";                            Category="Multimedia Tools" }
    @{ Name="HandBrake";             Id="HandBrake.HandBrake";                  Category="Multimedia Tools" }
    @{ Name="ImageGlass (Image Viewer)"; Id="DuongDieuPhap.ImageGlass";         Category="Multimedia Tools" }
    @{ Name="IrfanView";             Id="IrfanSkiljan.IrfanView";               Category="Multimedia Tools" }
    @{ Name="iTunes";                Id="Apple.iTunes";                         Category="Multimedia Tools" }
    @{ Name="K-Lite Codec Standard"; Id="CodecGuide.K-LiteCodecPack.Standard";  Category="Multimedia Tools" }
    @{ Name="Lightshot";             Id="Skillbrains.Lightshot";                Category="Multimedia Tools" }
    @{ Name="LibreOffice";           Id="TheDocumentFoundation.LibreOffice";    Category="Multimedia Tools" }
    @{ Name="Media Player Classic - Home Cine"; Id="clsid2.mpc-hc";             Category="Multimedia Tools" }
    @{ Name="mpc-qt";                Id="mpc-qt.mpc-qt";                        Category="Multimedia Tools" }
    @{ Name="Notepad++";             Id="Notepad++.Notepad++";                  Category="Multimedia Tools" }
    @{ Name="NAPS2 (Document Scanner)"; Id="Cyanfish.NAPS2";                    Category="Multimedia Tools" }
    @{ Name="nomacs";                Id="nomacs.nomacs";                        Category="Multimedia Tools" }
    @{ Name="OBS Studio";            Id="OBSProject.OBSStudio";                 Category="Multimedia Tools" }
    @{ Name="Obsidian";              Id="Obsidian.Obsidian";                    Category="Multimedia Tools" }
    @{ Name="ONLYOFFICE Desktop";    Id="ONLYOFFICE.DesktopEditors";            Category="Multimedia Tools" }
    @{ Name="Paint.NET";             Id="dotPDNLLC.paint.net";                  Category="Multimedia Tools" }
    @{ Name="ShareX (Screenshots)";  Id="ShareX.ShareX";                        Category="Multimedia Tools" }
    @{ Name="VLC (Video Player)";    Id="VideoLAN.VLC";                         Category="Multimedia Tools" }


    @{ Name="Advanced IP Scanner";   Id="Famatech.AdvancedIPScanner";           Category="Pro Tools" }
    @{ Name="Angry IP Scanner";      Id="angryziber.AngryIPScanner";            Category="Pro Tools" }
    @{ Name="CPU-Z";                 Id="CPUID.CPU-Z";                          Category="Pro Tools" }
    @{ Name="Display Driver Uninstaller"; Id="Wagnardsoft.DisplayDriverUninstaller"; Category="Pro Tools" }
    @{ Name="GPU-Z";                 Id="TechPowerUp.GPU-Z";                    Category="Pro Tools" }
    @{ Name="HWiNFO";                Id="REALiX.HWiNFO";                        Category="Pro Tools" }
    @{ Name="HWMonitor";             Id="CPUID.HWMonitor";                      Category="Pro Tools" }
    @{ Name="Mullvad VPN";           Id="MullvadVPN.MullvadVPN";                Category="Pro Tools" }
    @{ Name="Nmap";                  Id="Insecure.Nmap";                        Category="Pro Tools" }
    @{ Name="OpenVPN Connect";       Id="OpenVPNTechnologies.OpenVPNConnect";   Category="Pro Tools" }
    @{ Name="Proton VPN";            Id="Proton.ProtonVPN";                     Category="Pro Tools" }
    @{ Name="PuTTY";                 Id="PuTTY.PuTTY";                          Category="Pro Tools" }
    @{ Name="Simplewall";            Id="Henry++.simplewall";                   Category="Pro Tools" }
    @{ Name="Ventoy";                Id="Ventoy.Ventoy";                        Category="Pro Tools" }
    @{ Name="WinSCP";                Id="WinSCP.WinSCP";                        Category="Pro Tools" }
    @{ Name="WireGuard";             Id="WireGuard.WireGuard";                  Category="Pro Tools" }
    @{ Name="Wireshark";             Id="WiresharkFoundation.Wireshark";        Category="Pro Tools" }


    @{ Name="Jellyfin Media Player"; Id="Jellyfin.JellyfinMediaPlayer";         Category="Selfhosted Tools" }
    @{ Name="Jellyfin Server";       Id="Jellyfin.Server";                      Category="Selfhosted Tools" }
    @{ Name="Kodi Media Center";     Id="XBMCFoundation.Kodi";                  Category="Selfhosted Tools" }
    @{ Name="LocalSend";             Id="LocalSend.LocalSend";                  Category="Selfhosted Tools" }
    @{ Name="Moonlight/GameStream Client"; Id="MoonlightGameStreamingProject.Moonlight"; Category="Selfhosted Tools" }
    @{ Name="NetBird";               Id="netbirdio.netbird";                    Category="Selfhosted Tools" }
    @{ Name="Nextcloud Desktop";     Id="Nextcloud.NextcloudDesktop";           Category="Selfhosted Tools" }
    @{ Name="Plex Media Server";     Id="Plex.PlexMediaServer";                 Category="Selfhosted Tools" }
    @{ Name="Plex Desktop";          Id="Plex.Plex";                            Category="Selfhosted Tools" }
    @{ Name="Sunshine/GameStream Server"; Id="LizardByte.Sunshine";             Category="Selfhosted Tools" }


    @{ Name="1Password";             Id="AgileBits.1Password";                  Category="Utilities" }
    @{ Name="7-Zip";                 Id="7zip.7zip";                            Category="Utilities" }
    @{ Name="AnyDesk";               Id="AnyDeskSoftwareGmbH.AnyDesk";          Category="Utilities" }
    @{ Name="AutoHotkey";            Id="AutoHotkey.AutoHotkey";                Category="Utilities" }
    @{ Name="Bitwarden";             Id="Bitwarden.Bitwarden";                  Category="Utilities" }
    @{ Name="BlurAutoClicker";       Id="GamerNerd.BlurAutoClicker";            Category="Utilities" }
    @{ Name="Bulk Crap Uninstaller"; Id="Klocman.BulkCrapUninstaller";          Category="Utilities" }
    @{ Name="Crystal Disk Info";     Id="CrystalDewWorld.CrystalDiskInfo";      Category="Utilities" }
    @{ Name="Crystal Disk Mark";     Id="CrystalDewWorld.CrystalDiskMark";      Category="Utilities" }
    @{ Name="Deskflow";              Id="deskflow.deskflow";                    Category="Utilities" }
    @{ Name="Ente Auth";             Id="ente-io.auth";                         Category="Utilities" }
    @{ Name="F.lux";                 Id="Flux.Flux";                            Category="Utilities" }
    @{ Name="Files";                 Id="Files-Community.Files";                Category="Utilities" }
    @{ Name="GlazeWM";               Id="glzr-io.glazewm";                      Category="Utilities" }
    @{ Name="Google Drive";          Id="Google.GoogleDrive";                   Category="Utilities" }
    @{ Name="Hugo";                  Id="Hugo.Hugo.Extended";                   Category="Utilities" }
    @{ Name="JPEGView";              Id="sylikc.JPEGView";                      Category="Utilities" }
    @{ Name="KeePassXC";             Id="KeePassXCTeam.KeePassXC";              Category="Utilities" }
    @{ Name="MSEdgeRedirect";        Id="rcmaehl.MSEdgeRedirect";               Category="Utilities" }
    @{ Name="MSI Afterburner";       Id="Guru3D.Afterburner";                   Category="Utilities" }
    @{ Name="NanaZip";               Id="M2Team.NanaZip";                       Category="Utilities" }
    @{ Name="Nilesoft Shell";        Id="Nilesoft.Shell";                       Category="Utilities" }
    @{ Name="NVCleanstall";          Id="TechPowerUp.NVCleanstall";             Category="Utilities" }
    @{ Name="OFGB (Oh Frick Go Back)"; Id="xM4ddy.OFGB";                        Category="Utilities" }
    @{ Name="OpenRGB";               Id="CalcProgrammer1.OpenRGB";              Category="Utilities" }
    @{ Name="OPAutoClicker";         Id="OPAutoClicker.OPAutoClicker";          Category="Utilities" }
    @{ Name="Oracle VirtualBox";     Id="Oracle.VirtualBox";                    Category="Utilities" }
    @{ Name="Parsec";                Id="Parsec.Parsec";                        Category="Utilities" }
    @{ Name="PeaZip";                Id="Giorgiotani.Peazip";                   Category="Utilities" }
    @{ Name="Policy Plus";           Id="Fleex255.PolicyPlus";                  Category="Utilities" }
    @{ Name="Process Lasso";         Id="BitSum.ProcessLasso";                  Category="Utilities" }
    @{ Name="Proton Authenticator";  Id="Proton.Authenticator";                 Category="Utilities" }
    @{ Name="Proton Drive";          Id="Proton.ProtonDrive";                   Category="Utilities" }
    @{ Name="Proton Pass";           Id="Proton.ProtonPass";                    Category="Utilities" }
    ...
    @{ Name="Rufus Imager";          Id="Rufus.Rufus";                          Category="Utilities" }
    @{ Name="SignalRGB";             Id="WhirlwindFX.SignalRgb";                Category="Utilities" }
    @{ Name="Snappy Driver Installer Origin"; Id="GlennDelahoy.SnappyDriverInstallerOrigin"; Category="Utilities" }
    @{ Name="TeamViewer";            Id="TeamViewer.TeamViewer";                Category="Utilities" }
    @{ Name="TightVNC";              Id="GlavSoft.TightVNC";                    Category="Utilities" }
    @{ Name="Total Commander";       Id="Ghisler.TotalCommander";               Category="Utilities" }
    @{ Name="TranslucentTB";         Id="CharlesMilette.TranslucentTB";         Category="Utilities" }
    @{ Name="TreeSize Free";         Id="JAMSoftware.TreeSize.Free";            Category="Utilities" }
    @{ Name="UniGetUI";              Id="MartiCliment.UniGetUI";                Category="Utilities" }
    @{ Name="WinRAR";                Id="RARLab.WinRAR";                        Category="Utilities" }
    @{ Name="Wise Program Uninstaller"; Id="WiseCleaner.WiseProgramUninstaller"; Category="Utilities" }
    @{ Name="WizTree";               Id="AntibodySoftware.WizTree";             Category="Utilities" }
    @{ Name="HxD Hex Editor";        Id="MHNexus.HxD";                          Category="Utilities" }


    @{ Name="Spotify";               Id="Spotify.Spotify";                      Category="Other" }
)
        ...
        <TabControl Name="MainTabs" Background="#1E1E2E" Margin="8">
            ...
            <TabItem Header="Install Software">
                <Grid>
                    ...
                    <ScrollViewer Grid.Row="0">
                        <StackPanel Name="SoftwarePanel" Margin="10"/>
                    </ScrollViewer>
                    <StackPanel Grid.Row="1" Orientation="Horizontal" HorizontalAlignment="Left">
